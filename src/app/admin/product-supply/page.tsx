...
export default function WithdrawProduct() {
  ...
  const handleWithdraw = async () => {
    ...
    try {
      ...
      const data = await axios.post(`${DOMAIN}/api/supplies`, payload);
  ...
  return (
    <div className="max-w-lg mx-auto p-6 bg-white shadow-lg rounded-lg sm:mt-10">
      <h2 className="text-2xl font-semibold text-center mb-4">وارد المنتج</h2>
      ...
      >
        {loading ? <div className={style.loader}></div> : "تأكيد الوارد"}
      </button>
    </div>
  );
}
